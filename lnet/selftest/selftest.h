...
#define SWI_STATE_DONE			0
#define SWI_STATE_NEWBORN		1
#define SWI_STATE_REPLY_SUBMITTED	2
#define SWI_STATE_REPLY_SENT		3
#define SWI_STATE_REQUEST_SUBMITTED	4
#define SWI_STATE_REQUEST_SENT		5
#define SWI_STATE_REPLY_RECEIVED	6
#define SWI_STATE_BULK_STARTED		7
#define SWI_STATE_RUNNING		8
#define SWI_STATE_PAUSE			9
